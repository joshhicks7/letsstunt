 ...
 */
export function SquadMemberGallery({ group, colors, resolveProfile, onInvitePress }: Props) {
    ...
    <View style={styles.row}>
      {slots.map((slot, index) => {
        if (slot.kind === 'member') {
          ...
          return (
            <View key={slot.profileId} style={styles.cell} accessibilityLabel={`${label}${isCreator ? ', creator' : ''}`}>
