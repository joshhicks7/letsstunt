...
export const MOCK_PROFILES: StunterProfile[] = [
  ...
  baseProfile({
    ...
    skillTags: ['basket-toss', 'rewind', 'cupie'],
  ...
  baseProfile({
    ...
    displayName: 'Sam',
    birthday: '2000-07-22',
    primaryRole: 'male-side-base',
    secondaryRoles: [],
    positions: ['male-side-base'],
    skillLevel: 'intermediate',
    yearsExperience: 4,
    availability: ['weekends', 'events'],
    skillTags: ['coed-stunting', 'lib'],
  ...
  baseProfile({
    ...
    skillTags: ['all-girl', 'tumbling', 'basket-toss'],
  ...
  baseProfile({
    ...
    birthday: '2001-09-01',
    primaryRole: 'coed-flyer',
    secondaryRoles: ['basket-flyer'],
    positions: ['coed-flyer', 'basket-flyer'],
    skillLevel: 'intermediate',
    yearsExperience: 5,
    availability: ['weekends', 'events', 'competitions'],
    skillTags: ['basket-toss', 'rewind'],
...
export const MOCK_GROUPS: StuntGroup[] = [
  ...
  },
  {
    ...
    rolesNeeded: ['male-side-base', 'back-spot'],
  ...
  },
  {
    ...
    rolesFilled: ['all-girl-base', 'all-girl-flyer', 'female-side-base', 'back-spot'],
    rolesNeeded: [],
    availability: ['weekdays', 'competitions'],
    location: { city: 'Houston', region: 'TX', country: 'USA', lat: 29.76, lng: -95.37 },
